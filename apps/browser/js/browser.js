...
var Browser = {
  ...
  loadRemaining: function browser_loadRemaining() {
    ...
    var domElements = [
      ...
      'bookmark-menu-add-home', 'new-tab-button', 'tab-panels',
  ...
  setSearchProvider: function browser_setSearchProvider(uri, title, iconUri) {
    ...
    if (Awesomescreen) // If Awesomescreen is parsed
      Awesomescreen.defaultListItemTemplate = null; // clear cached element
  },
  ...
  removeBookmark: function browser_removeBookmark(e) {
    ...
    BrowserDB.removeBookmark(this.bookmarkMenuRemove.dataset.url,
      ...
      if (this.currentScreen == this.PAGE_SCREEN) {
        ...
        BrowserDB.getBookmarks(Awesomescreen.populateBookmarks.
          bind(Awesomescreen));
      }
    }).bind(this));
